import cv2
import os
def coloca_ROIs_imagem(imagem, rois, jogada):  
...
def main():
    ...
    while True:
        ...
        if key == ord('x'):
            ...
            imagem_com_ROIs = coloca_ROIs_imagem(imagem, rois, jogada)
            
            #Exibe a imagem da jogada com as ROIs
            cv2.imshow(f'Imagem com ROIs da jogada {jogada}', imagem_com_ROIs)
            cv2.waitKey(0)
